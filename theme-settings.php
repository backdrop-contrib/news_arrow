...
$form['news_arrow_backgrounds']['body_main_background'] = array(
      ...
      '#default_value' => theme_get_setting('body_main_background', 'news_arrow'),
    );
...
$form['news_arrow_backgrounds']['body_main_background_retina'] = array(
      ...
      '#default_value' => theme_get_setting('body_main_background_retina', 'news_arrow'),
    );

$form['news_arrow_backgrounds']['body_main_background_blurred'] = array(
      '#type' => 'checkbox',
      '#title' => t('Blur this background'),
      '#default_value' => theme_get_setting('body_main_background_blurred', 'news_arrow'),
    );
...
$form['news_arrow_backgrounds']['footer_main_background'] = array(
      ...
      '#default_value' => theme_get_setting('footer_main_background', 'news_arrow'),
    );
...
$form['news_arrow_backgrounds']['footer_main_background_retina'] = array(
      ...
      '#default_value' => theme_get_setting('footer_main_background_retina', 'news_arrow'),
    );

$form['news_arrow_backgrounds']['footer_main_background_blurred'] = array(
      '#type' => 'checkbox',
      '#title' => t('Blur this background'),
      '#default_value' => theme_get_setting('footer_main_background_blurred', 'news_arrow'),
    );
...
$form['news_arrow_backgrounds']['juiced_main_background'] = array(
      ...
      '#default_value' => theme_get_setting('juiced_main_background', 'news_arrow'),
    );
...
$form['news_arrow_backgrounds']['juiced_main_background_retina'] = array(
      ...
      '#default_value' => theme_get_setting('juiced_main_background_retina', 'news_arrow'),
    );

$form['news_arrow_backgrounds']['juiced_main_background_blurred'] = array(
      '#type' => 'checkbox',
      '#title' => t('Blur this background'),
      '#default_value' => theme_get_setting('juiced_main_background_blurred', 'news_arrow'),
    );
...
$form['news_arrow_backgrounds']['statement1_background'] = array(
      ...
      '#default_value' => theme_get_setting('statement1_background', 'news_arrow'),
    );
...
$form['news_arrow_backgrounds']['statement1_background_retina'] = array(
      ...
      '#default_value' => theme_get_setting('statement1_background_retina', 'news_arrow'),
    );

$form['news_arrow_backgrounds']['statement1_background_blurred'] = array(
      '#type' => 'checkbox',
      '#title' => t('Blur this background'),
      '#default_value' => theme_get_setting('statement1_background_blurred', 'news_arrow'),
    );
...
$form['news_arrow_backgrounds']['statement2_background'] = array(
      ...
      '#default_value' => theme_get_setting('statement2_background', 'news_arrow'),
    );
...
$form['news_arrow_backgrounds']['statement2_background_retina'] = array(
      ...
      '#default_value' => theme_get_setting('statement2_background_retina', 'news_arrow'),
    );

$form['news_arrow_backgrounds']['statement2_background_blurred'] = array(
      '#type' => 'checkbox',
      '#title' => t('Blur this background'),
      '#default_value' => theme_get_setting('statement2_background_blurred', 'news_arrow'),
    );
...
$form['news_arrow_backgrounds']['statement3_background'] = array(
      ...
      '#default_value' => theme_get_setting('statement3_background', 'news_arrow'),
    );
...
$form['news_arrow_backgrounds']['statement3_background_retina'] = array(
      ...
      '#default_value' => theme_get_setting('statement3_background_retina', 'news_arrow'),
    );

$form['news_arrow_backgrounds']['statement3_background_blurred'] = array(
      '#type' => 'checkbox',
      '#title' => t('Blur this background'),
      '#default_value' => theme_get_setting('statement3_background_blurred', 'news_arrow'),
    );
