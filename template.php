...
/**
 * @file
 * News Arrow parent theme template functions
 *
*/
 ...
 */
function news_arrow_preprocess_page(&$variables) {


$current_layout = "default";
$uses_admin_width = config_get('news_arrow.settings', 'use_max_width');
  if ($uses_admin_width) {

    $uses_layout_width1 = config_get('news_arrow.settings', 'max_width_element1');
    if ($uses_layout_width1 < 1) {
      $max_width_layouts1 = config_get('news_arrow.settings', 'site_layouts1');
      $max_width_number1 = config_get('news_arrow.settings', 'max_width_number1');
    ...
    $uses_layout_width2 = config_get('news_arrow.settings', 'max_width_element2');
    if ($uses_layout_width2 > 0) {
      $max_width_layouts2 = config_get('news_arrow.settings', 'site_layouts2');
      $max_width_number2 = config_get('news_arrow.settings', 'max_width_number2');
    ...
    $uses_layout_width3 = config_get('news_arrow.settings', 'max_width_element3');
    if ($uses_layout_width3 > 0) {
      $max_width_layouts3 = config_get('news_arrow.settings', 'site_layouts3');
      $max_width_number3 = config_get('news_arrow.settings', 'max_width_number3');
...
// backgrounds
// body region
$var1 = theme_get_setting('news_arrow_body_main_background', 'news_arrow');
$var2 = theme_get_setting('news_arrow_body_main_background_retina', 'news_arrow');
$var3 = theme_get_setting('news_arrow_body_main_background_blurred', 'news_arrow');
...
// calltoaction region
$var1 = theme_get_setting('news_arrow_footer_main_background', 'news_arrow');
$var2 = theme_get_setting('news_arrow_footer_main_background_retina', 'news_arrow');
$var3 = theme_get_setting('news_arrow_footer_main_background_blurred', 'news_arrow');
...
// juiced_main region
$var1 = theme_get_setting('news_arrow_juiced_main_background', 'news_arrow');
$var2 = theme_get_setting('news_arrow_juiced_main_background_retina', 'news_arrow');
$var3 = theme_get_setting('news_arrow_juiced_main_background_blurred', 'news_arrow');
...
// statement1 region
$var1 = theme_get_setting('news_arrow_statement1_background', 'news_arrow');
$var2 = theme_get_setting('news_arrow_statement1_background_retina', 'news_arrow');
$var3 = theme_get_setting('news_arrow_statement1_background_blurred', 'news_arrow');
...
// statement2 region
$var1 = theme_get_setting('news_arrow_statement2_background', 'news_arrow');
$var2 = theme_get_setting('news_arrow_statement2_background_retina', 'news_arrow');
$var3 = theme_get_setting('news_arrow_statement2_background_blurred', 'news_arrow');
...
// statement3 region
$var1 = theme_get_setting('news_arrow_statement3_background', 'news_arrow');
$var2 = theme_get_setting('news_arrow_statement3_background_retina', 'news_arrow');
$var3 = theme_get_setting('news_arrow_statement3_background_blurred', 'news_arrow');
...
function news_arrow_css_alter(&$css) {
  if (theme_get_setting('news_arrow_cdn') > 0)
  {
  $css_to_remove = array();
  $css_to_remove[] = backdrop_get_path('theme','news_arrow') . '/css/pure.min.css';
